...
const questions = [
  { id: 'services', question: 'What services do you offer?', answer: 'We combine website design and development, branding and UI/UX, SEO, paid advertising, social media, and creative production. Engagements can focus on one discipline or connect several around a business goal.', action: { label: 'Explore services', to: '/services' } },
  { id: 'website', question: 'Can you redesign my website?', answer: 'Yes. We can audit what is working, clarify the customer journey, redesign the interface, rebuild it in React, and strengthen performance, accessibility, SEO, and lead capture.', action: { label: 'Discuss your website', to: '/contact?service=web-design-development' } },
  { id: 'ai', question: 'Can you build AI solutions?', answer: 'Yes. We can shape AI-native products, agent workflows, business automations, and intelligent customer experiences—with clear controls, evaluation, and human oversight built in.', action: { label: 'Explore AI insights', to: '/blog' } },
