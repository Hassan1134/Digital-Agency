...
export const services = [
  ...
  {
    id: 'ecommerce-development', short: 'Ecommerce & Online Stores', title: 'Ecommerce Design & Development', icon: 'ShoppingCart',
    intro: 'Customer-focused online stores that make products easier to discover, trust, purchase, and return to, including Shopify builds.',
    suits: 'Retailers, direct-to-consumer brands, wholesalers, and established businesses opening or improving an online sales channel.',
    problem: 'Your store is difficult to navigate, costly to manage, slow to convert, or disconnected from stock, fulfilment, and marketing tools.',
    deliverables: ['Commerce strategy and platform selection', 'Product and collection architecture', 'Responsive storefront design', 'Checkout and payment integration', 'Inventory, shipping, and tax setup', 'Analytics and conversion foundations'],
    process: 'We map the buying journey and operational requirements, design the storefront, connect the commerce stack, migrate content where needed, and test every critical path before launch.',
    goals: ['launch', 'website', 'sales'],
  },
  {
    id: 'custom-software-saas', short: 'Custom Software & SaaS', title: 'Custom Software & SaaS Development', icon: 'AppWindow',
    intro: 'Purpose-built platforms, portals, and SaaS products that turn a strong idea or difficult internal process into reliable software.',
    suits: 'Founders validating a digital product and businesses that have outgrown spreadsheets, off-the-shelf tools, or disconnected processes.',
    problem: 'Existing software does not fit the workflow, a product idea needs technical direction, or manual operations are limiting growth.',
    deliverables: ['Product discovery and technical roadmap', 'User roles and workflow design', 'Interactive product prototype', 'Frontend and backend development', 'API and third-party integrations', 'Testing, deployment, and documentation'],
    process: 'We reduce the idea to a valuable first release, prototype the riskiest journeys, build in measured stages, and use real feedback to guide what comes next.',
    goals: ['launch', 'website', 'sales'],
  },
  {
    id: 'mobile-app-development', short: 'Mobile App Development', title: 'Mobile App Design & Development', icon: 'Smartphone',
    intro: 'Useful, intuitive mobile experiences designed around the moments customers and teams handle on the move.',
    suits: 'Startups launching an app, businesses extending an existing platform, and teams replacing fragile mobile workflows.',
    problem: 'Customers need a better mobile experience, the current app is difficult to use, or an idea needs a practical route to launch.',
    deliverables: ['Mobile product strategy', 'User flows and interactive prototype', 'iOS and Android interface design', 'Cross-platform app development', 'Backend and service integrations', 'Store submission and release support'],
    process: 'We validate the core use case, design for real device behaviour, build and test in focused releases, then prepare the product for a confident launch.',
    goals: ['launch', 'website', 'sales', 'brand'],
  },
  {
  ...
  {
    id: 'crm-email-marketing', short: 'CRM & Email Marketing', title: 'CRM, Email & Lifecycle Marketing', icon: 'MailCheck',
    intro: 'Connected customer journeys that turn new leads, active buyers, and past customers into stronger long-term relationships.',
    suits: 'Businesses with growing lead or customer lists that need clearer segmentation, follow-up, nurturing, and retention systems.',
    problem: 'Leads go cold, customer data is fragmented, email is mostly ad hoc, or teams cannot see what happens after an enquiry or purchase.',
    deliverables: ['CRM and lifecycle audit', 'Platform and data-flow planning', 'Segmentation and lead scoring', 'Automated email journeys', 'Campaign templates and copy', 'Deliverability and reporting setup'],
    process: 'We map the customer lifecycle, clean up data and consent requirements, prioritise the highest-value journeys, then build and improve them from real engagement signals.',
    goals: ['enquiries', 'sales', 'brand'],
  },
  {
    id: 'analytics-conversion', short: 'Analytics & Conversion', title: 'Analytics & Conversion Optimisation', icon: 'ChartSpline',
    intro: 'Decision-ready measurement and conversion improvements that show what customers do and where growth is being lost.',
    suits: 'Websites, ecommerce stores, and digital products with meaningful traffic but incomplete tracking or underperforming journeys.',
    problem: 'Reports are difficult to trust, teams optimise from opinions, or visitors repeatedly drop out before an important action.',
    deliverables: ['Measurement and tracking audit', 'Analytics and tag implementation', 'Conversion funnel definition', 'Dashboard and reporting setup', 'UX and conversion review', 'Experiment roadmap and test design'],
    process: 'We define the decisions measurement must support, repair the data foundation, diagnose friction, and prioritise experiments by evidence, impact, and effort.',
    goals: ['website', 'enquiries', 'sales'],
  },
  {
    id: 'cybersecurity-support', short: 'Security, Hosting & Care', title: 'Cybersecurity, Hosting & Website Care', icon: 'ShieldCheck',
    intro: 'Practical protection, reliable hosting, and ongoing technical care that keep important digital services healthy after launch.',
    suits: 'Businesses that depend on a website, store, or digital product and need clearer ownership of security, updates, uptime, and recovery.',
    problem: 'Updates are neglected, backups are untested, security responsibilities are unclear, or recurring technical issues distract the team.',
    deliverables: ['Security and dependency review', 'Hosting and deployment setup', 'Backups and recovery planning', 'Monitoring and incident alerts', 'Updates and maintenance roadmap', 'Ongoing support and performance care'],
    process: 'We assess the current risk and operational setup, secure the highest-priority gaps, document recovery paths, and establish a transparent care rhythm.',
    goals: ['website', 'sales', 'brand'],
  },
]
